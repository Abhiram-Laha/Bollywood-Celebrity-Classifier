...
def get_b64_test_image_for_abhi():
...
if __name__ == '__main__':
    ...
    print(classify_image(get_b64_test_image_for_abhi(), None))
    '''
    ...
    print(classify_image(None, "./test_images/5.png"))
    ...
    print(classify_image(None, "./test_images/9.jpg"))
    print(classify_image(None, "./test_images/10.jpg"))
     '''
